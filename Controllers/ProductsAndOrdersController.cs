...
{
    public class ProductsAndOrdersController : ControllerBase
    {
        private readonly CitybreakContext _context;
        private readonly PasswordHasher<memberTable> _passwordHasher;
        private readonly ILogger<ProductsAndOrdersController> _logger;
        public ProductsAndOrdersController(CitybreakContext context, ILogger<ProductsAndOrdersController> logger)
        {
            _context = context;
